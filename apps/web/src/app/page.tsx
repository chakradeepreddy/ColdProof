        ...
        <section className="py-20 reveal">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col items-center space-y-0 w-full">
              ...
              <ArchNode
                label="ColdProof CLI"
                sub="npm install -g coldproof@0.1.1"
                highlight
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="mt-5 flex items-center gap-2">
                <code className="text-xs font-mono bg-[#08090A] border border-border/50 px-3 py-1.5 rounded text-primary/70">npm install -g coldproof@0.1.1</code>
              </div>
            </div>
            <div className="space-y-0">
              {[
